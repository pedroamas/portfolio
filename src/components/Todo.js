    ...
    <ListGroup.Item>
      <Form onSubmit={handleSubmit}>
        ...
        <ButtonGroup className="btn-group-sm">
          <Button variant="outline-dark" onClick={() => setEditing(false)}>
            Cancel
          </Button>
      ...
      <Form.Group className="float-left">
        <Form.Check className="big-checkbox">
          <Form.Check.Input
            ...
            id={props.id}
            onChange={() =>
              props.toggleTaskCompleted(props.id, props.completed)
            }
            defaultChecked={props.completed}
          />
          <Form.Check.Label className="task-label align-middle">
            {props.name}
          </Form.Check.Label>
        </Form.Check>
      </Form.Group>

...
function MinesweeperGame(props) {
  ...
  return (
    <>
            ...
            <Col>
              <InputGroup>
                ...
                <FormControl
                  ...
                  placeholder="Mines"
                  ref={minesRef}
                  defaultValue={dificulty.medium.mines}
                />
              </InputGroup>
            </Col>
            <Col>
              <InputGroup>
                ...
                <FormControl
                  ...
                  placeholder="Height"
                  ref={heightRef}
                  defaultValue={dificulty.medium.height}
                />
              </InputGroup>
            </Col>
            <Col>
              <InputGroup>
                ...
                <FormControl
                  ...
                  placeholder="Width"
                  ref={widthRef}
                  defaultValue={dificulty.medium.width}
                />
              </InputGroup>
            </Col>
            <Col>
              <Button variant="primary" onClick={newGameClick}>
                New Game
              </Button>
            </Col>
          </Row>
      ...
      <h4 className="text-center" id="reminingMines">
        Mines: {reminingMines}
      </h4>
      {initialize()}
    </>
  ...
  function showMines() {
    for (let i = 0; i < height; i++) {
      for (let j = 0; j < width; j++) {
        ...
        if (
          minesweeper[i][j] == "-1" &&
          $(idBoxSelected).hasClass("hiddenBox") &&
          !$(idBoxSelected).hasClass("flag")
        ) {
  ...
  function ponerMinas(minas, iSelected = -1, jSelected = -1) {
    ...
    while (i < minas && minesOverflow < 150) {
      ...
      minesOverflow++;
      if (
        (iSelected != mine_i || jSelected != mine_j) &&
